...
arb xs = join $ [liftM2 Add (arb t1) (arb t2) | (t1, t2) <- groups xs] ++ [liftM2 Sub (arb t1) (arb t2) | (t1, t2) <- groups xs] ++ [liftM2 Mult (arb t1) (arb t2) | (t1, t2) <- groups xs] ++ [liftM2 Div (arb t1) (arb t2) | (t1, t2) <- groups xs]
